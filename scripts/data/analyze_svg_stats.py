...
from scripts.data.process_svg import get_svg_quality_stats
from scripts.data.sample_dataset import DATASETS
from scripts.data.utils import build_split_output_path
